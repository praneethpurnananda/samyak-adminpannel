...
export class SamyakUsersComponent implements OnInit {
  ...
  data = [
    {position: 1, name: 'Purnananda Praneeth', samyak_id: 'SMK2K2000000', email: 'praneeth.mandalemula@gmail.com', mobile: '8977190130', college: 'KLU', college_id: '180030660', email_verified: 'True'},
  ]
